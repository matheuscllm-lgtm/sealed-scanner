...
def main() -> None:
    ...
    lines.append("")
    lines.append("| # | Status | Produto (EN) | TCG (R$, média) | Liga (R$) | Margem bruta % | Δ R$/unid |")
    lines.append("|---|---|---|---:|---:|---:|---:|")
    ...
    lines.append("- **Margem bruta %** = (TCG − Liga) / Liga × 100 — só preço vs preço, SEM taxas/frete. Custos operacionais ficam fora do scanner (o operador calcula por fora).")
